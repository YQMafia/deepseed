...
class Generator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=512, seqL=1000, bias=True, layer_num=1, num_heads=16):
...
class WGAN():
    ...
    def __init__(self, input_nc, output_nc, seqL=100, lr=1e-4, gpu_ids='0', l1_w=10):
        ...
        self.l1_w = l1_w
        self.device = torch.device('cuda:{}'.format(self.gpu_ids)) if self.gpu_ids else torch.device('cpu')
...
def main():
    ...
    n_critics = 5
    n_iters = 10000
    model = WGAN(input_nc=5, output_nc=5, seqL=1000, gpu_ids='cpu', l1_w=30)
